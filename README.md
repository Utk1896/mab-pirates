...
A pirate-themed Multi-Armed Bandit tournament platform for RL mentorship programs.
...
- **Auto-evaluation** — code runs in a subprocess with 60-second timeout
...
### 2. (Optional) Set mentor password
...
Visit:
- Student site: http://localhost:8000
- Mentor dashboard: http://localhost:8000/mentor

---

## Student Interface

The agent file must define a class `BanditAgent` with:
